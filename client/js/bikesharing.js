var bikeSharingLayer ={
  ...
  getBikeBrands : function(callback){
		integreen.getStationDetails('bikesharing-ws/rest/bikes/',{},displayBrands);
		...
		function getCurrentBikesharingData(details,data){
			...
			var config={
				types:[["availability","","Indicates if a vehicle is available for rental","300"]]
                        ...
                        integreen.getChildStationsData(details.id,"bikesharing-ws/rest/bikes/",displayCurrentState,config);
