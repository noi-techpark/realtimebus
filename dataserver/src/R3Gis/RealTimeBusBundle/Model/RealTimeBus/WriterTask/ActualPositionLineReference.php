...
class ActualPositionLineReference implements Executable {
    ...
    public function getLineReference(array $feature) {
        $retval = array(
            'li_nr' => 'null',
            'str_li_var' => null,
            'li_lfd_nr' => 'null',
...
EOQ;
            ...
            $retval = $this->db->query($getLineSegmentSql)->fetchAll(\PDO::FETCH_ASSOC);
            $retval = $retval[0];
        }
        return $retval;
    }
